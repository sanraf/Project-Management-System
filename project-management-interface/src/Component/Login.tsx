        ...
        <div className="page-row">
          <div className="user_login">
            <div className="user_login_details">
              <div>
                <h5 style={{ display: showRegister }}>
                  Please Register before login
                </h5>
                <p style={{ display: showRegister }}>
                  New to our system? please register your details to use the
                  system
                </p>
              </div>
              <div
                style={{ display: showRegister == "block" ? "none" : "block" }}
              >
                <h5>Please Login</h5>
                <p>Thank you for choosing us, if registered please login</p>
              </div>
              <span id="registerText" onClick={() => setShowRegister("block")}>
              ...
              <form action="" onSubmit={handleSubmit(login)}>
                <div style={{ display: showRegister }}>
                  ...
                  <input
                    {...register("fullName", {
                      required: showRegister == "block" ? true : false,
                    })}
                    id="fullname"
                    name="fullName"
                    type="text"
                ...
                />
                <p
                  style={{ display: showRegister == "none" ? "block" : "none" }}
                  id="forgot_password"
                >
                  Forgot Password ?
                </p>
                <div style={{ display: showRegister }}>
                  ...
                  <p style={{ display: passwordMessage }} id="wrong_password">
                    Attention: Passwords do not match, please ensure they match
                    to proceed
                  </p>
                  <input
              ...
              <h6 style={{ display: emailMessage }} id="confirm_message">
                Thank you for registering please confirm via email before
                logging in{" "}
              </h6>
          ...
          <div className="login_project_description">
            <div className="login_project_title">
              ...
              <p>
                Hello and welcome to ProjectMaster! We're delighted to have you
                join our community of project managers and teams who are
                achieving remarkable success with our powerful project
                management platform.
              </p>
            </div>
